...
type (
	tweenFunc func(t, b, c, d float32) float32
	Tween     struct {
		duration float32
		time     float32
		begin    float32
...
func (tween *Tween) Set(time float32) (float32, bool) {
	var current float32
...
func (tween *Tween) Reset() (float32, bool) {
	return tween.Set(0)
}

func (tween *Tween) Update(dt float32) (float32, bool) {
